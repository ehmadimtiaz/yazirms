...
setInterval(function(){ 
	$.ajax({
		url:base_url+"Kitchen/get_new_orders_ajax",
		method:"POST",
		data:{
			csrf_test_name: $.cookie('csrf_cookie_name')
		},
				...
				$order_list_left += '<div '+selected_background+' class="single_order fix" data-order-type="'+order_type+'" data-selected="'+selected_unselected+'" id="single_order_'+response[key].sales_id+'">';	
					$order_list_left += '<div class="inside_single_order_container fix">';
						...
						$order_list_left += '<div class="order_condition_on_done_start">';
							$order_list_left += '<p class="order_condition_on_progress_items">Started Cooking: '+total_kitchen_type_started_cooking_items+'/'+total_kitchen_type_items+'</p>';
							$order_list_left += '<p class="order_condition_done_items">Done: '+total_kitchen_type_done_items+'/'+total_kitchen_type_items+'</p>';
						$order_list_left += '</div>';
						$order_list_left += '<div class="order_condition_on_done_start">';
