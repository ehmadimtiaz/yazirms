            ...
            <div id="receiptData">
                ...
                <div id="receipt-data">
                    <div class="text-center">
                        ...
                        <p><?php echo $this->session->userdata('address'); ?>
                            ...
                            if ($this->session->userdata['vat_reg_no'] && $this->session->userdata('collect_vat')=='Yes'):
                                ...
                                <br>
                                VAT Reg: <?php
                            echo $this->session->userdata('vat_reg_no');
                        endif;
                            ?>
                    ...
                    <table class="table table-condensed">
                        ...
                        <?php
                        if (($this->session->userdata['collect_vat'] == "Yes" || $sale_object->vat == "0.00" || $sale_object->vat == "0" || $sale_object->vat == 0) && $this->session->userdata('collect_vat')=='Yes'):
                            ?>
                            <th>Vat</th>
                            <th class="text-right"><?php echo $this->session->userdata('currency') . " " . number_format($sale_object->vat, 2); ?></th>
                            <?php
                        endif;
                        ?>
                        </tr>
