                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 17%">Total Payable</th> 
                                <th style="width:4%">Payment Method</th>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu"> 
                                                ...
                                                <li><a style="cursor: pointer" onclick="change_date(<?= $value->id ?>)"><i class="fa fa-calendar tiny-icon"></i>Change Date</a></li>
  ...
  <div class="modal-dialog" role="document" style="width:300px;">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #3c8dbc;">
        <h5 class="modal-title" style="font-size: 20px;text-align: center;color: #ececec;line-height: 20px;">Change Date</h5>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="save_change_date">Save changes</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal" id="close_change_date_modal">Close</button>
      </div>
    </div>
  </div>
</div>
