<?php 
	...
	if(count($getUnReadyOrders)>0){
		...
		foreach($getUnReadyOrders as $singleOrder){
			...
			$show_all_orders .= '<p class="order_condition_on_progress_items">Started Cooking: '.$total_kitchen_type_started_cooking_items.'/'.$total_kitchen_type_items.'</p>';
			$show_all_orders .= '<p class="order_condition_done_items">Done: '.$total_kitchen_type_done_items.'/'.$total_kitchen_type_items.'</p>';
			$show_all_orders .= '</div>';
			$show_all_orders .= '<div class="order_condition_on_done_start">';
...
<body>
	...
	<div class="wrapper fix">
		<div class="top fix">
			<h1 class="main_header">Kitchen Panel</h1>  
		...
		<div class="bottom fix">
			...
			<div class="bottom_right fix floatleft">
				...
				<div class="bottom_right_b fix">
					...
					<button class="floatleft" id="start_cooking">Start Cooking</button><button class="floatleft" id="cooking_done">Done</button>
				</div>
			</div>
		</div>
	</div>	
