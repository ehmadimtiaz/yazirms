                    ...
                    <div class="col-md-4" style="margin-bottom: 10px;">
                        ...
                        <div style="width: 100%; float: left;">
                            <div style="width: 30%; float: left; margin-right: 3.33%">
                                <a style="padding: 12px;" class="btn btn-success btn btn-block" href="<?php echo base_url(); ?>Outlet/setOutletSession/<?php echo $this->custom->encrypt_decrypt($value->id, 'encrypt'); ?>"> <strong>Enter</strong></a>                                
                            </div>
                            <div style="width: 30%; float: left; margin-right: 3.33%">
                            ...
                            <div style="width: 33.33%; float: left;">
                                <a style="padding: 12px;" class="btn btn-danger btn btn-block delete" href="<?php echo base_url() ?>Outlet/deleteOutlet/<?php echo $this->custom->encrypt_decrypt($value->id, 'encrypt'); ?>">  <strong>Delete</strong></a>
                            </div>
