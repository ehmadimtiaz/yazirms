...
class Sale extends CI_Controller {
    ...
    public function POS($encrypted_id = "") {
        ...
        $data['waiters'] = $this->Sale_model->getWaitersForThisCompany($company_id,'tbl_employees');
    ...
    function add_customer_by_ajax(){
        ...
        $data['address'] = trim($this->input->post($this->security->xss_clean('customer_delivery_address')));
        $data['user_id'] = $this->session->userdata('user_id');
        $data['company_id'] = $this->session->userdata('company_id');
        $this->db->insert('tbl_customers', $data);
