...
class Sale_model extends CI_Model {
     ...
     * This method get all waiters based on company id from tbl_employees
     */
    ...
    {
      $this->db->select("tbl_holds.*,tbl_employees.name as waiter_name,tbl_customers.name as customer_name,tbl_tables.name as table_name");
      $this->db->from('tbl_holds');
      $this->db->join('tbl_customers', 'tbl_customers.id = tbl_holds.customer_id', 'left');
      $this->db->join('tbl_employees', 'tbl_employees.id = tbl_holds.waiter_id', 'left');
      $this->db->join('tbl_tables', 'tbl_tables.id = tbl_holds.table_id', 'left');
